            ...
            <div className={styles['form-left']}>
              ...
              >
                ...
                {data &&
                  data.map((registro) => (
                    <option
                      key={registro.idMembresia}
                      value={registro.idMembresia}
                    >
            ...
            <div className={styles['form-right']}>
              <div className={styles.webcam}>
                <Webcam
                  ...
                  className={styles['webcam-container']}
                />
                <button onClick={capturePhoto} className={styles.capture}>
                  Capturar Imagen
                </button>
                {photoData !== '' ? (
                  <span>Foto capturada</span>
                ) : (
                  <span>Aun no se ha capturado</span>
                )}
              </div>
            </div>
          </form>
